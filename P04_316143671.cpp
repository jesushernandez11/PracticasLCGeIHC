...
int main()
{
	...
	*/
	...
	glm::mat4 model_patas_D(1.0f); //Matriz de modelo auxiliar para las patas delanteras
	glm::mat4 model_patas_T(1.0f); //Matriz de modelo auxiliar para las patas traseras
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::scale(model, glm::vec3(2.0f, 7.0f, 1.0f));
		...
		//articulación continuación pierna
		model = model_patas_T;
		model = glm::translate(model, glm::vec3(-2.5f, 4.0f, 1.0f));
		...
		model_patas_T = model;
		model = glm::translate(model, glm::vec3(-3.5f, 4.0f, 0.0f));
